...
import {FullHeightLink} from "../../../../authenticated/media/FullHeightLink";
import {MediaPageLogic, MediaPageMediasState, MediaPageMediasStateInit} from "../../../../authenticated/media/logic";
import MediaNavBar from "../../../../authenticated/media/MediaNavBar";
import {Key, useNativeControl} from "../../../../authenticated/media/useNativeControl";
...
export default function MediaPage() {
    ...
    return (
        <div {...handlers}>
            ...
            <MediaNavBar backUrl={backToAlbumLink} backId="go_back" downloadHref={imgSrc}
                         downloadId="download_current"/>
        </div>
    )
}

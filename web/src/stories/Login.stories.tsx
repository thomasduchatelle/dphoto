...
import {
  ...
  reduce,
} from "../pages/Login/domain/login-reducer";
...
const Template: ComponentStory<typeof LoginInternal> = (args) => (
  <LoginInternal {...args}>
    <Button
      sx={{
        width: "100%",
...
const stateWhilePrompting = reduce(initialLoginPageState, {
...
OnError.args = reduce(stateWhilePrompting, {
  type: "error",

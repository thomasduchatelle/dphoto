...
import {CatalogViewerAction} from "./catalog-reducer-v2";

// THIS FILE IS ONLY *TEMPORARY* TO VALIDATE THE REFACTORING WAS SUCCESSFUL AND FREE FROM REGRESSION

const catalogReducerFunction = require("./catalog-reducer-v2").catalogReducer;

...
// NewBArchiveAdapter creates a new instance of BArchiveAdapter. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewBArchiveAdapter(t testing.TB) *BArchiveAdapter {

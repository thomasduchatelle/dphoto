...
// NewDetailsReaderAdapter creates a new instance of DetailsReaderAdapter. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewDetailsReaderAdapter(t testing.TB) *DetailsReaderAdapter {

...
// NewDynamoQuery creates a new instance of DynamoQuery. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewDynamoQuery(t testing.TB) *DynamoQuery {
	mock := &DynamoQuery{}
	mock.Mock.Test(t)

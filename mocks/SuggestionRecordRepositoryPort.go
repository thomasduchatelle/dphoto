...
// NewSuggestionRecordRepositoryPort creates a new instance of SuggestionRecordRepositoryPort. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewSuggestionRecordRepositoryPort(t testing.TB) *SuggestionRecordRepositoryPort {

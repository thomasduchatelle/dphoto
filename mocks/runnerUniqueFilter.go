...
// newRunnerUniqueFilter creates a new instance of runnerUniqueFilter. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newRunnerUniqueFilter(t testing.TB) *runnerUniqueFilter {

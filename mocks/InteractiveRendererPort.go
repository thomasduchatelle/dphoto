...
// NewInteractiveRendererPort creates a new instance of InteractiveRendererPort. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewInteractiveRendererPort(t testing.TB) *InteractiveRendererPort {

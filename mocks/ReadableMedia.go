...
// NewReadableMedia creates a new instance of ReadableMedia. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewReadableMedia(t testing.TB) *ReadableMedia {
	mock := &ReadableMedia{}
	mock.Mock.Test(t)

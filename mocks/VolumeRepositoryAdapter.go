...
// NewVolumeRepositoryAdapter creates a new instance of VolumeRepositoryAdapter. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewVolumeRepositoryAdapter(t testing.TB) *VolumeRepositoryAdapter {
	mock := &VolumeRepositoryAdapter{}
	mock.Mock.Test(t)

...
// NewGetStreamAdapter creates a new instance of GetStreamAdapter. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewGetStreamAdapter(t testing.TB) *GetStreamAdapter {

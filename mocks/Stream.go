...
// NewStream creates a new instance of Stream. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.

...
// NewCArchiveAdapter creates a new instance of CArchiveAdapter. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewCArchiveAdapter(t testing.TB) *CArchiveAdapter {

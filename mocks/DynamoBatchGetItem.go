...
// NewDynamoBatchGetItem creates a new instance of DynamoBatchGetItem. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewDynamoBatchGetItem(t testing.TB) *DynamoBatchGetItem {

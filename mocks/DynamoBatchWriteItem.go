...
// NewDynamoBatchWriteItem creates a new instance of DynamoBatchWriteItem. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewDynamoBatchWriteItem(t testing.TB) *DynamoBatchWriteItem {

...
// NewMediaScannerAdapter creates a new instance of MediaScannerAdapter. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMediaScannerAdapter(t testing.TB) *MediaScannerAdapter {
	mock := &MediaScannerAdapter{}
	mock.Mock.Test(t)

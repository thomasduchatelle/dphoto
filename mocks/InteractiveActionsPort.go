...
// NewInteractiveActionsPort creates a new instance of InteractiveActionsPort. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewInteractiveActionsPort(t testing.TB) *InteractiveActionsPort {

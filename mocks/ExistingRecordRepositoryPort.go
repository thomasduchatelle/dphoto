...
// NewExistingRecordRepositoryPort creates a new instance of ExistingRecordRepositoryPort. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewExistingRecordRepositoryPort(t testing.TB) *ExistingRecordRepositoryPort {

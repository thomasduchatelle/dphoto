...
func (_m *ScopesReader) FindScopesById(ids ...accesscontrol.ScopeId) ([]*accesscontrol.Scope, error) {
...
func (_m *ScopesReader) ListUserScopes(email string, types ...accesscontrol.ScopeType) ([]*accesscontrol.Scope, error) {

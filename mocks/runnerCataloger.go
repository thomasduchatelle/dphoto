...
// newRunnerCataloger creates a new instance of runnerCataloger. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newRunnerCataloger(t testing.TB) *runnerCataloger {

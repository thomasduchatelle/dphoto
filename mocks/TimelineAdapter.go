...
// NewTimelineAdapter creates a new instance of TimelineAdapter. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewTimelineAdapter(t testing.TB) *TimelineAdapter {

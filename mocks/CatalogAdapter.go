...
// NewCatalogAdapter creates a new instance of CatalogAdapter. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewCatalogAdapter(t testing.TB) *CatalogAdapter {
	mock := &CatalogAdapter{}
	mock.Mock.Test(t)

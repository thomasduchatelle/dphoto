...
func (_m *RepositoryAdapter) DeleteEmptyAlbum(id catalog.AlbumId) error {
	ret := _m.Called(id)
...
func (_m *RepositoryAdapter) FindExistingSignatures(owner catalog.Owner, signatures []*catalog.MediaSignature) ([]*catalog.MediaSignature, error) {
...
func (_m *RepositoryAdapter) FindMediaCurrentAlbum(owner catalog.Owner, mediaId catalog.MediaId) (*catalog.AlbumId, error) {
...
func (_m *RepositoryAdapter) FindMediaIds(request *catalog.FindMediaRequest) ([]catalog.MediaId, error) {
...
func (_m *RepositoryAdapter) InsertMedias(owner catalog.Owner, media []catalog.CreateMediaRequest) error {
...
func (_m *RepositoryAdapter) TransferMedias(owner catalog.Owner, mediaIds []catalog.MediaId, newFolderName catalog.FolderName) error {

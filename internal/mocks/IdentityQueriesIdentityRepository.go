...
type mockConstructorTestingTNewIdentityQueriesIdentityRepository interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewIdentityQueriesIdentityRepository(t mockConstructorTestingTNewIdentityQueriesIdentityRepository) *IdentityQueriesIdentityRepository {

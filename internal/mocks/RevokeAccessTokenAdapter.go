...
type mockConstructorTestingTNewRevokeAccessTokenAdapter interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewRevokeAccessTokenAdapter(t mockConstructorTestingTNewRevokeAccessTokenAdapter) *RevokeAccessTokenAdapter {

...
func (_m *CountMediasBySelectorsPort) CountMediasBySelectors(ctx context.Context, owner catalog.Owner, selectors []catalog.MediaSelector) (int, error) {
...
func (_c *CountMediasBySelectorsPort_CountMediasBySelectors_Call) Run(run func(ctx context.Context, owner catalog.Owner, selectors []catalog.MediaSelector)) *CountMediasBySelectorsPort_CountMediasBySelectors_Call {
...
func (_c *CountMediasBySelectorsPort_CountMediasBySelectors_Call) RunAndReturn(run func(context.Context, catalog.Owner, []catalog.MediaSelector) (int, error)) *CountMediasBySelectorsPort_CountMediasBySelectors_Call {
	_c.Call.Return(run)
	return _c
}

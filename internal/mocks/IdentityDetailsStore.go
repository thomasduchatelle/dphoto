...
func (_c *IdentityDetailsStore_FindIdentity_Call) Run(run func(email string)) *IdentityDetailsStore_FindIdentity_Call {
...
func (_c *IdentityDetailsStore_FindIdentity_Call) RunAndReturn(run func(string) (*aclcore.Identity, error)) *IdentityDetailsStore_FindIdentity_Call {
	_c.Call.Return(run)
	return _c
}

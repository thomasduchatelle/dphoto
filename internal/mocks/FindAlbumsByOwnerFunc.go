...
func (_m *FindAlbumsByOwnerFunc) Execute(ctx context.Context, owner catalog.Owner) ([]*catalog.Album, error) {
...
func (_c *FindAlbumsByOwnerFunc_Execute_Call) Run(run func(ctx context.Context, owner catalog.Owner)) *FindAlbumsByOwnerFunc_Execute_Call {
...
func (_c *FindAlbumsByOwnerFunc_Execute_Call) RunAndReturn(run func(context.Context, catalog.Owner) ([]*catalog.Album, error)) *FindAlbumsByOwnerFunc_Execute_Call {
	_c.Call.Return(run)
	return _c
}

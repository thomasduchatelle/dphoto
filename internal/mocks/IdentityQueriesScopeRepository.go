...
func (_c *IdentityQueriesScopeRepository_ListScopesByOwners_Call) Run(run func(owners []string, types ...aclcore.ScopeType)) *IdentityQueriesScopeRepository_ListScopesByOwners_Call {
...
func (_c *IdentityQueriesScopeRepository_ListScopesByOwners_Call) RunAndReturn(run func([]string, ...aclcore.ScopeType) ([]*aclcore.Scope, error)) *IdentityQueriesScopeRepository_ListScopesByOwners_Call {
	_c.Call.Return(run)
	return _c
}

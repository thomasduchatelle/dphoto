...
type mockConstructorTestingTNewIdentityQueriesScopeRepository interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewIdentityQueriesScopeRepository(t mockConstructorTestingTNewIdentityQueriesScopeRepository) *IdentityQueriesScopeRepository {

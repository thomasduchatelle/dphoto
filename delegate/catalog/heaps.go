...
// return: TRUE if new element took the head
func (a *albumHeap) HeapPush(album *Album) bool {
	heap.Push(a, album)
	return album.IsEqual(a.heap[0])
}

// remove album fro heap and return TRUE if it was the head
...
// Copy of the heap: slice where the first element is the head of the heap

...
func TestCreate(t *testing.T) {
	...
	RepositoryMock.On("UpdateMedias", catalog.NewUpdateFilter().WithAlbum("/2020-Q4", "/2021-Q1", "/Christmas_Holidays").WithinRange(start, catalog.MustParse(layout, "2020-12-31T18")).WithinRange(catalog.MustParse(layout, "2021-01-01T18"), end), MoveTo("/2020-12_Christm_s_2nd-week")).Return("", 0, nil)
...
func TestDelete(t *testing.T) {
	...
	RepositoryMock.On("UpdateMedias", catalog.NewUpdateFilter().WithAlbum(deletedFolder, q4).WithinRange(catalog.MustParse(layout, "2020-12-18T00"), catalog.MustParse(layout, "2020-12-24T00")), MoveTo("/Christmas_First_Week")).Return("", 0, nil)
	RepositoryMock.On("UpdateMedias", catalog.NewUpdateFilter().WithAlbum(deletedFolder, q4, "/Christmas_First_Week").WithinRange(catalog.MustParse(layout, "2020-12-24T00"), catalog.MustParse(layout, "2020-12-26T00")), MoveTo("/Christmas_Day")).Return("", 0, nil)
	RepositoryMock.On("UpdateMedias", catalog.NewUpdateFilter().WithAlbum(deletedFolder, q1, q4).WithinRange(catalog.MustParse(layout, "2020-12-31T18"), catalog.MustParse(layout, "2021-01-01T18")), MoveTo("/New_Year")).Return("", 0, nil)
...
func TestRename_updateFolderName(t *testing.T) {
	...
	RepositoryMock.On("UpdateMedias", catalog.NewUpdateFilter().WithAlbum("/Christmas_Holidays"), "/2020-12_Covid_Lockdown_3").Return("", 0, nil)
...
func TestUpdate(t *testing.T) {
	...
	RepositoryMock.On("UpdateMedias", catalog.NewUpdateFilter().WithAlbum(christmas, updatedFolder, q4).WithinRange(catalog.MustParse(layout, "2020-12-24T00"), catalog.MustParse(layout, "2020-12-26T00")), MoveTo("/Christmas_Day")).Return("", 0, nil)

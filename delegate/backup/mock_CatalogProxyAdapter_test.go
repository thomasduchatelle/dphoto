...
// MockCatalogProxyAdapter is an autogenerated mock type for the CatalogProxyAdapter type
type MockCatalogProxyAdapter struct {
	mock.Mock
}

// Create provides a mock function with given fields: createRequest
func (_m *MockCatalogProxyAdapter) Create(createRequest catalog.CreateAlbum) error {
...
func (_m *MockCatalogProxyAdapter) FindAllAlbums() ([]*catalog.Album, error) {
	ret := _m.Called()
...
func (_m *MockCatalogProxyAdapter) FindSignatures(signatures []*catalog.MediaSignature) ([]*catalog.MediaSignature, error) {
...
func (_m *MockCatalogProxyAdapter) InsertMedias(medias []catalog.CreateMediaRequest) error {

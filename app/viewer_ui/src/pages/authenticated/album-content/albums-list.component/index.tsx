...
import {Album, AlbumId} from "../../../../core/domain/catalog";
import {HotIndicator} from "./hot-indicator";

const AlbumsListComponent = ({albums, loaded, selected, onSelect}: {
  albums: Album[]
  loaded: boolean
  selected?: Album
    ...
    <Box sx={{overflow: 'auto'}}>
      <List>
        ...
        {albums.map((album, index) => (
          <div key={album.albumId.owner + album.albumId.folderName}>
            <ListItemButton
